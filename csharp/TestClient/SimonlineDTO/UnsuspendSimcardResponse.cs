...
namespace SimonlineDTO
{
    ...
    public class UnsuspendSimcardResponse : IDTO
    {
        [DataMember]
        [ApiMember(Description="Imsi that have been successfully queued for suspension", DataType="ARRAY[Unsigned Integer]", ParameterType="body", IsRequired=true)]
